...
export const createTopic = async (
    ...
    const existingTopic =
        await topicRepo.findTopicBySlug(
            normalizedSlug
        );
...
export const getPublishedTopics = async (
    ...
    const {
        ...
        await topicRepo.findPublishedTopics({
            page,
            limit,
        });
...
export const publishTopic = async (
    ...
    return topicRepo.updateTopicStatus(
        id,
        "PUBLISHED"
    );
};
...
export const searchTopics = async (
    ...
    return topicRepo.searchPublishedTopics(
        trimmedSearchTerm
    );
};